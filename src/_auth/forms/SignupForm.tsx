  ...
  return (
    <Form {...form}>
      <div className="sm:w-420 flex-center flex-col">
        ...
        <p className="text-light-3 md:base-regular mt-2">To use Snapgram, please enter your information</p>
        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="flex flex-col gap-5 w-full mt-4">
          ...
          <p className="text-center small-regular">
            ...
            <Link className="text-primary-500 small-semibold ml-2" to="/sign-in">
              Login
            </Link>
          </p>
        </form>
